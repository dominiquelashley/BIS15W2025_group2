  ...
  tags$style(HTML("
    ...
    tabItems(
      ...
      tabItem(tabName = "introduction",
               ...
               tags$p("In this project we aim to summarize and explain the trends seen in spotify top songs collected in 2023. Our inspiration for the project is the Spotify Wrpped summaries that come out each year, but instead of individual reports per person we use global spotify data for this project.")),
